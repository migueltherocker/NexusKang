...
public class SizeSeekBarPreference extends Preference 
 ...
 public SizeSeekBarPreference(Context context) {
  super(context);
 }
 ...
 public SizeSeekBarPreference(Context context, AttributeSet attrs, int defStyle) {
