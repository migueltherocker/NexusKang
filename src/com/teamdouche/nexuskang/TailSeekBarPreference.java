...
public class TailSeekBarPreference extends Preference 
                          implements OnSeekBarChangeListener{

 
 public static int maximum    = 150;
 ...
 public TailSeekBarPreference(Context context) {
  super(context);
 }
 
 public TailSeekBarPreference(Context context, AttributeSet attrs) {
  super(context, attrs);
 }
 
 public TailSeekBarPreference(Context context, AttributeSet attrs, int defStyle) {
